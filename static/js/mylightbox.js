...
<div id="mylightbox-controls"><a href="#" id="mylightbox-close" class="close_button" title="'+myLightboxSettings['close_link_title']+'" onclick="return false"><span>'+myLightboxSettings['close_link']+'</span></a></div>\
</div>\
